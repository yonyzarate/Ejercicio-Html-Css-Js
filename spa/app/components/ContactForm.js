export function ContactForm() {
  const d = document,
    ...
    $style = d.getElementById("dynamic-style");
  ...
  function validationsForm() {
    ...
    d.addEventListener("submit", (e) => {
      ...
      fetch("https://formsubmit.co/ajax/yony.zarate96@gmail.com", {
        method: "POST",
        ...
        .catch((err) => {
          console.log(err);
          let message =
            err.statusText || "Ocurrío un error al enviar, intenta nuevamente";
